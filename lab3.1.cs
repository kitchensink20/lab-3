//Дано текст, необхідно кожне слово (слова складаються з чисел і букв) помістити в колекцію,
//вивести загальну кількість елементів колекції, запросити ввести користувача порядковий номер
//елемента і напрямок руху по колекції, згідно введеному напрямку вивести всі слова починаючи з заданого.
using System;
